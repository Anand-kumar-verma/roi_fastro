  ...
  return (
    <>
      ...
      <div className="bg-gray-200 p-6  rounded-lg lg:px-32">
        <h2 className="text-xl text-gray-800 font-bold my-2">
          Associate Sign-up
        </h2>
        <form
          onSubmit={handleSubmit}
          className="p-10 !mb-10 bg-white border border-gray-400 rounded"
        >
          ...
          <div className="flex flex-col mt-4 gap-2 justify-center">
            <div className="mt-4">
              ...
              <label htmlFor="terms" className="text-sm text-gray-600">
                By clicking the button you have confirmed accept the Meta Prime
                - Online Forex Trading Terms & Conditions and
