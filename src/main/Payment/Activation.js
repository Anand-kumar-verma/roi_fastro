...
function Activation() {
  ...
  return (
    <>
      ...
      <div
        className="flex min-h-screen flex-col justify-center items-center bg-background"
        // style={{ backgroundImage: `url(${crypto})` }}
      >
        <Box className="!cursor-pointer !bg-gray-color !bg-opacity-75 rounded p-1 lg:!mt-10 !flex !flex-col !justify-center gap-2 lg:w-[30%] w-full">
