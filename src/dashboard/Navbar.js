      ...
      <div className="flex justify-between px-10 text-sm h-16 items-center">
        ...
        <div className="flex font-medium items-center gap-10">
          ...
          >
            ...
            {/* Navigation Links */}
            <p
              className="flex items-center gap-2 cursor-pointer p-2 text-gray-700"
              onClick={() => {
                navigate("/home");
            ...
            >
              ...
              {openDropdown === "affiliate" && (
                <div className="absolute left-0 bg-white shadow-md rounded w-48 p-3 z-40">
                  <div
                    className="cursor-pointer flex items-center gap-2 py-1 hover:text-blue-400 text-gray-700"
            ...
            >
              ...
              {openDropdown === "income" && (
                <div className="absolute left-0  bg-white shadow-md rounded w-48 p-3 z-40">
                  <div
                    className="cursor-pointer py-1 hover:text-blue-400 text-gray-700"
            ...
            <div
              className="cursor-pointer py-1 flex items-center gap-2 lg:hidden hover:text-blue-400 text-gray-700"
